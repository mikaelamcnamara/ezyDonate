...
public class FirebaseTransHistViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public FirebaseTransHistViewHolder(View itemView) {
        super(itemView);
        eView = itemView;
