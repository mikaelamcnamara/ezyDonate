...
public class FirebaseTransUserHistViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public FirebaseTransUserHistViewHolder(View itemView) {
        super(itemView);
        eView = itemView;
    ...
    public void bindDonation(Donation donation) {


        ImageView eventImageView = (ImageView) eView.findViewById(R.id.trans_img_id);
        final TextView titleTextView = (TextView) eView.findViewById(R.id.trans_user_id);
        event_description = (TextView) eView.findViewById(R.id.trans_date_id);
        TextView dateTextView = (TextView) eView.findViewById(R.id.trans_amount_id);
...
//        });
        ...
        titleTextView.setText(donation.getUsername());
        event_description.setText(donation.getDate());
        dateTextView.setText("$" + donation.getDonation());
    }
